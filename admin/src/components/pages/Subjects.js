                    ...
                    <div id="page-content-wrapper">
                        <div className="container-fluid">
                            <div className="button-bottom">
                                ...
                                <button className="btn btn-outline-primary float-right mt-3 mr-2" data-toggle="modal" data-target="#add-subject-modal"><FontAwesomeIcon icon={faPlus}/> Add Subject</button>
                            </div>
                            <h1 className="mt-2 text-primary">Subject List</h1>
                            <ReactDatatable
                                config={this.config}
